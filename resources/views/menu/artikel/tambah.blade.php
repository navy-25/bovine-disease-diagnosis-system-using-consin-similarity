    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">                
                ...
                <form action="/artikelstore" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="7" name="sinopsis"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="konten">Konten</label> 
                        <textarea class="form-control" rows="20" name="konten"></textarea>
                    </div>
                    <div class="form-group">
