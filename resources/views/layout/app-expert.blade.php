            ...
            <aside class="left-sidebar">
                <div class="scroll-sidebar">
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            <li> <a class="waves-effect waves-dark" href="{{url('expert')}}" aria-expanded="false"><i class="fa fa-home"></i><span class="hide-menu">Dashboard</span></a>
                            </li>
                            <li> <a class="waves-effect waves-dark" href="{{url('datapenyakit')}}" aria-expanded="false"><i class="fa fa-paw"></i><span class="hide-menu">Data Penyakit</span></a>
                            </li>
                            <li> <a class="waves-effect waves-dark" href="{{url('list_artikel')}}" aria-expanded="false"><i class="fa fa-bullhorn"></i><span class="hide-menu">Artikel</span></a>
                            </li>
